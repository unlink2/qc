...
#define qc_warn(...)                                                         \
  qc_log_fprintf(stderr, QC_LOG_LEVEL_WARN, __VA_ARGS__)
#define qc_info(...)                                                         \
  qc_log_fprintf(stderr, QC_LOG_LEVEL_INFO, __VA_ARGS__)
#define qc_error(...)                                                        \
  qc_log_fprintf(stderr, QC_LOG_LEVEL_ERROR, __VA_ARGS__)
